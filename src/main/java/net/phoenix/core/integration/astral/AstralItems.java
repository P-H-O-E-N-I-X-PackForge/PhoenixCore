...
public class AstralItems {
    ...
    public static final ItemEntry<AstralThreadCellItem> ASTRAL_THREAD_CELL = REGISTRATE
            ...
            .properties(p -> p.stacksTo(1))
            .model((ctx, prov) -> prov.generated(ctx, ResourceLocation.fromNamespaceAndPath("minecraft", "item/ender_pearl")))
    ...
    public static final ItemEntry<AstralCodexItem> ASTRAL_CODEX = REGISTRATE
            ...
            .properties(p -> p.stacksTo(1))
            .model((ctx, prov) -> prov.generated(ctx, ResourceLocation.fromNamespaceAndPath("minecraft", "item/enchanted_book")))
            .lang("§dAstral Codex")
            .register();
